...
$(window).load(function() {
	...
	if($defaultViewMode=="full"){
		...
		$toolbar_a.html("<img src='/static/template/arturo.interpegasus.com/images/toolbar_fs_icon.png' width='50' height='50'  />").attr("onClick", "ImageViewMode('full');return false").attr("title", "Maximize");
	}
