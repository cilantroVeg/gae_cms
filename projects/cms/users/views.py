...
def forgot_password(request):
    if is_logged_in(request) is True:
        ...
        return render_to_response('users/forgot_password.html', context_instance=RequestContext(request))
...
def process_forgot_password(request):
    ...
    if u:
        ...
        return render_to_response('users/forgot_password.html', {'my_error_message': "Email Is Not Found"},
                                  context_instance=RequestContext(request))
