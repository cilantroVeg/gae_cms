...
if True:
    ...
    ACCESS_TOKEN = access_keys.BIBLE_ACCESS_TOKEN
    ACCESS_SECRET = access_keys.BIBLE_ACCESS_SECRET    
...
# Share
BIBLE_GOOGLE_PUBLIC_API_KEY = access_keys.BIBLE_GOOGLE_PUBLIC_API_KEY
