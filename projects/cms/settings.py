...
if False:
    ...
    FACEBOOK_PAGE_ID = access_keys.NRWL7_FACEBOOK_PAGE_ID
    FACEBOOK_APP_ID = access_keys.NRWL7_FACEBOOK_APP_ID
    FACEBOOK_APP_SECRET = access_keys.NRWL7_FACEBOOK_APP_SECRET
    FACEBOOK_ACCESS_TOKEN = access_keys.NRWL7_FACEBOOK_ACCESS_TOKEN
    SHORT_URL_API = access_keys.BIBLE_GOOGLE_PUBLIC_API_KEY
