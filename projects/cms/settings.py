...
if False:
    ...
    TWEET_KEY = access_keys.IPEGASUS_TWEET_KEY
    ...
    TWEET_KEY = access_keys.NRWL_TWEET_KEY
    TWEET_SECRET = access_keys.NRWL_TWEET_SECRET
    TWEET_ACCESS_TOKEN = access_keys.NRWL_ACCESS_TOKEN
    TWEET_ACCESS_SECRET = access_keys.NRWL_ACCESS_SECRET
    FACEBOOK_PAGE_ID = access_keys.NRWL_FACEBOOK_PAGE_ID
    FACEBOOK_APP_ID = access_keys.NRWL_FACEBOOK_APP_ID
    FACEBOOK_APP_SECRET = access_keys.NRWL_FACEBOOK_APP_SECRET
    FACEBOOK_ACCESS_TOKEN = access_keys.NRWL_FACEBOOK_ACCESS_TOKEN
    SHORT_URL_API = access_keys.BIBLE_GOOGLE_PUBLIC_API_KEY
    ...
    TWEET_KEY = access_keys.BIBLE_TWEET_KEY
    TWEET_SECRET = access_keys.BIBLE_TWEET_SECRET
    TWEET_ACCESS_TOKEN = access_keys.BIBLE_ACCESS_TOKEN
    TWEET_ACCESS_SECRET = access_keys.BIBLE_ACCESS_SECRET
    FACEBOOK_PAGE_ID = access_keys.BIBLE7_FACEBOOK_PAGE_ID
    FACEBOOK_APP_ID = access_keys.BIBLE7_FACEBOOK_APP_ID
    FACEBOOK_APP_SECRET = access_keys.BIBLE7_FACEBOOK_APP_SECRET
    FACEBOOK_ACCESS_TOKEN = access_keys.BIBLE7_FACEBOOK_ACCESS_TOKEN
    SHORT_URL_API = access_keys.BIBLE_GOOGLE_PUBLIC_API_KEY
...
GOOGLE_CLIENT_ID     = access_keys.ARTURO_PEGASUS7_CLIENT_ID
GOOGLE_CLIENT_SECRET = access_keys.ARTURO_PEGASUS7_CLIENT_SECRET
GOOGLE_REFRESH_TOKEN = access_keys.ARTURO_PEGASUS7_REFRESH_TOKEN
